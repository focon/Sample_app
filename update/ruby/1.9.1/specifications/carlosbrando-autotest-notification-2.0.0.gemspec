...
Gem::Specification.new do |s|
  s.name = %q{carlosbrando-autotest-notification}
  s.version = "2.0.0"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Carlos Brando", "Rodrigo Urubatan", "Alexandre da Silva", "Carlos Júnior", "Davis Zanetti Cabral", "Marcos Tapajós", "Thiago Pradi", "Ozéias Sant'ana", "Samuel Flores", "Diego Carrion"]
  s.date = %q{2009-08-24}
