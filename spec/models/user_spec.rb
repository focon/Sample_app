...
describe "password encrytpion" do
     before(:each) do
    ...
    @user.should respond_to(:encrypted_password)
     ...
     it "should set the encryted password  attribute" do
...
describe "has password_method" do
...
User.should respond_to(:authenticate)
    ...
    it "should return nil for the email password mismatch" do 
 User.authenticate(@attr[:email], "wrongpass").should be_nil
    end
    it "should return nil for the email address with no user password mismatch" do 
 User.authenticate("bar@foo.com",@attr[:password]).should be_nil
    end
    it "should return the user on the email password match" do 
